    ...
    <>
      <div className="max-w-2xl mx-auto mt-10 p-8">
        <div className="bg-white p-8 rounded-lg shadow-lg text-center relative">
          ...
          <button onClick={() => setIsModalOpen(true)} className="mt-6 flex items-center gap-2 mx-auto bg-teal-600 text-white font-bold py-2 px-5 rounded-lg hover:bg-teal-700 transition"><Edit2 size={18} /> Update Profile</button>
        </div>
      </div>
      {isModalOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50 p-4">
          <div className="bg-white p-8 rounded-lg shadow-2xl w-full max-w-md relative">
            <button onClick={() => setIsModalOpen(false)} className="absolute top-4 right-4 text-gray-400 hover:text-gray-700"><X size={24} /></button>
            ...
            <form onSubmit={handleUpdate} className="space-y-4">
              ...
              <button type="submit" disabled={formLoading} className="w-full flex items-center justify-center gap-2 bg-teal-600 text-white py-3 rounded-lg font-semibold hover:bg-teal-700 disabled:bg-gray-400">
                <Save size={18} />
