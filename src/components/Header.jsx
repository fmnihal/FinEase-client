...
//         <Link to="/" className="text-2xl font-bold text-gray-900">FinEase</Link>
//         <div>
//           {loading ? (
//             <p>Loading...</p>
//           ) : user ? (
...
//             // User is logged out
//             <>
//               <Link to="/login" className="text-gray-600 font-medium hover:text-teal-600 mr-4">
//                 Login
//               </Link>
//               <Link to="/register" className="bg-teal-600 text-white font-bold py-2 px-4 rounded-lg hover:bg-teal-700">
//                 Sign Up
//               </Link>
//             </>
//           )}
          ...
          {loading ? (
            ...
            <>
              ...
              <div className="flex items-center space-x-3">
                <span className="text-sm text-gray-600">Hi, {user.displayName || user.email.split('@')[0]}</span><button onClick={handleLogout} className="bg-red-500 text-white font-bold p-2 rounded-full hover:bg-red-600 transition duration-300" title="Logout"><LogOut className="h-5 w-5" /></button>
              </div>
            </>
          ) : (
            <div className="flex items-center space-x-3">
